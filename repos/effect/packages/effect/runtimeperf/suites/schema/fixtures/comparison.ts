...
export const effectTagged100InvalidSelected = effectCase(
  effectTagged100,
  taggedInvalidSelected,
  false,
);
...
export const effectMultiSentinel100ValidFirst = effectCase(
  effectMultiSentinel100,
  multiSentinelValidFirst,
  true,
);
