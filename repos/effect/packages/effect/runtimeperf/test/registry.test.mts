...
describe("runtimeperf registry", () => {
  ...
  it("keeps the focused Schema diagnostics Effect-only", () => {
    ...
    assert.equal(
      diagnostics.every((fixture) => fixture.implementation === "effect"),
      true,
    );
  });
  ...
  it("includes the complete effect@beta Schema Benchmarks matrix", () => {
    ...
    assert.deepEqual(
      fixtures
        .filter(
          (fixture) => fixture.suite === "schema-benchmarks" && fixture.implementation === "effect",
        )
  ...
  it("includes the complete Valibot and Zod Schema Benchmarks matrices", () => {
    ...
    const names = (implementation) =>
      fixtures
        .filter(
          (fixture) =>
            fixture.suite === "schema-benchmarks" && fixture.implementation === implementation,
        )
        .map((fixture) => fixture.name)
        .sort();
