 ...
 * @since 4.0.0
 */
export class SqlSyntaxError extends Schema.TaggedError<SqlSyntaxError>(
 ...
 * @since 4.0.0
 */
export class ConstraintError extends Schema.TaggedError<ConstraintError>(
 ...
 * @since 4.0.0
 */
export class LockTimeoutError extends Schema.TaggedError<LockTimeoutError>(
 ...
 * @since 4.0.0
 */
export class ResultLengthMismatch extends Schema.TaggedError<ResultLengthMismatch>(
