...
export function context(options?: {
  ...
  const resolveMemoMap = (get: AtomContext): Layer.MemoMap =>
    isAtom(memoMap) ? get(memoMap) : memoMap;
  ...
  function factory<E, R>(
    ...
    self.read = function read(get: AtomContext) {
      ...
      const build = Effect.flatMap(Effect.scope, (scope) =>
        Layer.buildWithMemoMap(layer, resolveMemoMap(get), scope),
      );
...
} = dual(2, <T extends Atom<any>>(self: T, equals: (value: Type<T>, next: Type<T>) => boolean): T =>
  Object.assign(Object.create(Object.getPrototypeOf(self)), {
    ...self,
    equals,
  }),
...
} = dual(2, <A, B>(self: Atom<A>, f: (_: A) => B): Atom<B> =>
...
} = dual(2, <R, W>(self: Writable<R, W>, value: W): Effect.Effect<void, never, AtomRegistry> =>
...
} = dual(2, <A extends Atom<any>>(self: A, read: (get: <A>(atom: Atom<A>) => A) => Type<A>): A =>
  Object.assign(Object.create(Object.getPrototypeOf(self)), {
    ...self,
...
} = dual(2, <A>(self: Atom<A>, registry: Registry.AtomRegistry): A =>
