    ...
    > {
      ...
      const inspectResponse = (
        ...
        const retryAfter = parseRetryAfter(
          clock,
          getHeader(response.headers, ...headerNames.retryAfter),
        );
