...
} = dual(2, (self: HttpServerResponse, key: string): HttpServerResponse =>
  makeResponse({
    ...self,
...
} = dual(2, (self: HttpServerResponse, cookies: Cookies.Cookies): HttpServerResponse =>
...
} = dual(2, (self: HttpServerResponse, body: Body.HttpBody): HttpServerResponse =>
...
const makeResponse = (
  ...
  if (
    ...
    if (
      self.body.contentLength !== undefined &&
      (!preferHeaders || newHeaders["content-length"] === undefined)
    ) {
