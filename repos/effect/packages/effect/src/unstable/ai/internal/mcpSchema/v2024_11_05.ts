...
export const PromptOrToolContent = Schema.Union([TextContent, ImageContent, EmbeddedResource]);

export const SamplingContent = Schema.Union([TextContent, ImageContent]);
...
export class ServerRequestRpcs extends RpcGroup.make(Ping, CreateMessage, ListRoots) {}
