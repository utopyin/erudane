...
} = dual(2, <A, E>(self: TxDeferred<A, E>, result: Result<A, E>): Effect.Effect<boolean> =>
...
} = dual(2, <A, E>(self: TxDeferred<A, E>, value: A): Effect.Effect<boolean> =>
...
} = dual(2, <A, E>(self: TxDeferred<A, E>, error: E): Effect.Effect<boolean> =>
