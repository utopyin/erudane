...
} = dual(2, <A, E, E2>(self: Result<A, E>, f: (err: E) => E2): Result<A, E2> =>
...
} = dual(2, <A, E, A2>(self: Result<A, E>, f: (ok: A) => A2): Result<A2, E> =>
...
} = dual(2, <A, E, A2, E2>(self: Result<A, E>, f: (a: A) => Result<A2, E2>): Result<A2, E | E2> =>
