...
export const appendAll: {
  <B>(that: Iterable<B>): <A>(self: Iterable<A>) => Iterable<A | B>;
  <A, B>(self: Iterable<A>, that: Iterable<B>): Iterable<A | B>;
} = dual(2, <A, B>(self: Iterable<A>, that: Iterable<B>): Iterable<A | B> => ({
  [Symbol.iterator]() {
...
} = dual(2, <A, B>(self: Iterable<A>, f: (a: A, i: number) => Iterable<B>): Iterable<B> =>
  flatten(map(self, f)),
);
...
} = dual(2, <A, B>(self: Iterable<A>, f: (a: A) => B): Iterable<NonNullable<B>> =>
  filterMap(self, (a) => {
    const b = f(a);
...
export const cartesianWith: {
  ...
  <A, B, C>(self: Iterable<A>, that: Iterable<B>, f: (a: A, b: B) => C): Iterable<C>;
} = dual(3, <A, B, C>(self: Iterable<A>, that: Iterable<B>, f: (a: A, b: B) => C): Iterable<C> => ({
  [Symbol.iterator]() {
    const cache: Array<B> = [];
