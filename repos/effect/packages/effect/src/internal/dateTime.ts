...
} = dual(2, (self: DateTime.DateTime, other: DateTime.DateTime): Duration.Duration =>
...
/** @internal */
export const toEpochSeconds = (self: DateTime.DateTime): number =>
  Math.floor(self.epochMilliseconds / 1000);
...
} = dual(2, (self: DateTime.DateTime, duration: Duration.Input): DateTime.DateTime =>
