...
const randomBytes = (): Uint8Array<ArrayBuffer> =>
...
/** @internal */
export const v4String = (bytes?: Uint8Array): string =>
  stringify(bytes === undefined ? v4Bytes() : v4Bytes(bytes));

const maxV7Timestamp = 2 ** 48 - 1;

/** @internal */
export function v7Bytes(timestampMillis: number): Uint8Array<ArrayBuffer>;
export function v7Bytes<A extends ArrayBufferLike>(
