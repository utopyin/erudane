...
} = dual(2, <A>(self: TxChunk<A>, chunk: Chunk.Chunk<A>): Effect.Effect<void> =>
...
} = dual(2, <A>(self: TxChunk<A>, element: A): Effect.Effect<void> =>
...
} = dual(2, <A>(self: TxChunk<A>, n: number): Effect.Effect<void> =>
...
} = dual(3, <A>(self: TxChunk<A>, start: number, end: number): Effect.Effect<void> =>
...
} = dual(2, <A>(self: TxChunk<A>, f: (a: A) => A): Effect.Effect<void> =>
...
} = dual(2, <A>(self: TxChunk<A>, predicate: (a: A) => boolean): Effect.Effect<void> =>
...
} = dual(2, <A>(self: TxChunk<A>, other: Chunk.Chunk<A>): Effect.Effect<void> =>
