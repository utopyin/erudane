...
describe("HttpApiClient", () => {
  ...
  describe("endpoint", () => {
    ...
    it("selects within the requested group when endpoint identifiers overlap", () => {
      class UsersEndpointError extends Schema.TaggedError<UsersEndpointError>()(
        "UsersEndpointError",
        {},
      ) {}
      class AdminsEndpointError extends Schema.TaggedError<AdminsEndpointError>()(
        "AdminsEndpointError",
        {},
      ) {}
      class UsersClientError extends Schema.TaggedError<UsersClientError>()(
        "UsersClientError",
        {},
      ) {}
      class AdminsClientError extends Schema.TaggedError<AdminsClientError>()(
        "AdminsClientError",
        {},
      ) {}
