...
describe("Types", () => {
  ...
  it("UnionToIntersection", () => {
    expect<Types.UnionToIntersection<{ a: string } | { b: number }>>().type.toBe<{
      a: string;
      b: number;
    }>();
  });
  ...
  it("ExtractTag", () => {
    expect<
      Types.ExtractTag<string | { _tag: "a"; a: number } | { _tag: "b"; b: number }, "b"> & unknown
  ...
  describe("MergeRight", () => {
    ...
    it("mutable overwrites readonly", () => {
      expect<
        Types.MergeRight<{ readonly a: number; b: number }, { a: string; c: boolean }>
      >().type.toBe<{ a: string; c: boolean; b: number }>();
    });

    it("readonly overwrites mutable", () => {
      expect<
        Types.MergeRight<{ a: number; b: number }, { readonly a: string; c: boolean }>
    ...
    it("optionality of non involved keys must be preserved", () => {
      expect<
        Types.MergeRight<{ readonly a?: number; b: number }, { readonly c?: string }>
  ...
  describe("Mutable", () => {
    it("should convert a readonly object to mutable", () => {
      expect<Types.Mutable<{ readonly a: string; readonly b: number }>>().type.toBe<{
        a: string;
        b: number;
      }>();
    });
  ...
  describe("DeepMutable", () => {
    ...
    describe("Index Signature", () => {
      it("should convert an readonly Index Signature to a mutable Index Signature", () => {
        expect<Types.DeepMutable<{ readonly [x: string]: number }>>().type.toBe<{
          [x: string]: number;
        }>();
      });
    ...
    describe("Struct", () => {
      ...
      it("should deeply mutate nested structs", () => {
        expect<
          Types.DeepMutable<ReadonlyArray<TaggedValues<TaggedValues<TaggedValues<boolean>>>>>
        >().type.toBe<
          Array<{
            _tag: string;
            value: Array<{
    ...
    describe("Tuple", () => {
      it("should convert a readonly tuple", () => {
        expect<Types.DeepMutable<readonly [string, number, boolean]>>().type.toBe<
    ...
    describe("ReadonlySet", () => {
      it("should convert a ReadonlySet to a mutable Set", () => {
        expect<
          Types.DeepMutable<ReadonlySet<{ readonly value: TaggedValues<number> }>>
    ...
    describe("ReadonlyMap", () => {
      it("should convert a ReadonlyMap to a mutable Map", () => {
        expect<
          Types.DeepMutable<ReadonlyMap<TaggedValues<string>, ReadonlySet<TaggedValues<number>>>>
        >().type.toBe<
      ...
      it("should leave a mutable Map unchanged", () => {
        expect<
          Types.DeepMutable<Map<TaggedValues<string>, ReadonlySet<TaggedValues<number>>>>
        >().type.toBe<
          Map<{ _tag: string; value: Array<string> }, Set<{ _tag: string; value: Array<number> }>>
        >();
      });
