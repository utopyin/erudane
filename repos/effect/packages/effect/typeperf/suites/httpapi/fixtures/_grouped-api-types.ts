...
type EndpointIdentifiers50 =
  | Exclude<`getUser00${ZeroToFour}${Digit}`, "getUser0000">
  | "getUser0050";
...
type EndpointIdentifiers<Count extends EndpointCount> = Count extends 10
  ? EndpointIdentifiers10
  : Count extends 50
    ? EndpointIdentifiers50
    : Count extends 100
      ? EndpointIdentifiers100
...
type Endpoint<Identifier extends string> = Identifier extends string
...
export type Group<
  Count extends EndpointCount,
  TopLevel extends boolean = false,
> = HttpApiGroup.HttpApiGroup<"users", Endpoint<EndpointIdentifiers<Count>>, TopLevel>;
