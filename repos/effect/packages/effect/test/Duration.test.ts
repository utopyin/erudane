...
describe("Duration", () => {
  it("fromInputUnsafe", () => {
    ...
    deepStrictEqual(Duration.fromInputUnsafe("-1.5 nanos"), Duration.nanos(-2n));
    deepStrictEqual(
      Duration.fromInputUnsafe("9007199254740993.1 nanos"),
      Duration.nanos(9_007_199_254_740_993n),
    );
    deepStrictEqual(
      Duration.fromInputUnsafe("-9007199254740993.5 nanos"),
      Duration.nanos(-9_007_199_254_740_994n),
    );
