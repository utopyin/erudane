...
const isString: Predicate.Refinement<unknown, string> = (u: unknown): u is string =>
  typeof u === "string";
...
const isNonEmptyString: Predicate.Refinement<string, NonEmptyString> = (s): s is NonEmptyString =>
  s.length > 0;
