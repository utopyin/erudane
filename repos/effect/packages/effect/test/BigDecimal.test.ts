...
describe("BigDecimal", () => {
  ...
  it("round: to-zero (truncate)", () => {
    ...
    assertEquals(
      BigDecimal.round($("0.12345678987654321"), { mode: "to-zero", scale: 13 }),
      $("0.1234567898765"),
    );
    assertEquals(
      BigDecimal.round($("-0.12345678987654321"), { mode: "to-zero", scale: 13 }),
  ...
  it("round: from-zero", () => {
    ...
    assertEquals(
      BigDecimal.round($("0.12345678987654321"), { mode: "from-zero", scale: 13 }),
      $("0.1234567898766"),
    );
    assertEquals(
      BigDecimal.round($("-0.12345678987654321"), { mode: "from-zero", scale: 13 }),
  ...
  it("round: half-to-zero", () => {
    ...
    assertEquals(BigDecimal.round($("-1.95"), { mode: "half-to-zero", scale: 1 }), $("-1.9"));
    assertEquals(
      BigDecimal.round($("0.1234567898765"), { mode: "half-to-zero", scale: 12 }),
      $("0.123456789876"),
    );
    assertEquals(
      BigDecimal.round($("-0.1234567898765"), { mode: "half-to-zero", scale: 12 }),
  ...
  it("round: half-from-zero", () => {
    ...
    assertEquals(BigDecimal.round($("-1.95"), { mode: "half-from-zero", scale: 1 }), $("-2"));
    assertEquals(
      BigDecimal.round($("0.1234567898765"), { mode: "half-from-zero", scale: 12 }),
      $("0.123456789877"),
    );
    assertEquals(
      BigDecimal.round($("-0.1234567898765"), { mode: "half-from-zero", scale: 12 }),
