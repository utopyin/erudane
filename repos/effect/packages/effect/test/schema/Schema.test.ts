...
describe("Schema", () => {
  it("keeps synchronous decode and encode effects eager", () => {
    ...
    ): Exit.Exit<A, Schema.SchemaError> => {
...
Missing key
  ...
  at ["b"]`,
      ...
      it("Struct & check & unsafePreserveChecks: true", async () => {
        ...
        await decoding.fail({ a: "", b: "b", c: "c" }, `Expected a === b`);
      });
    });
...
Expected no excess property
  ...
  it("Trimmed", async () => {
    ...
    const decoding = asserts.decoding();
    await decoding.succeed("a");
    await decoding.fail(" a ", `Expected a string with no leading or trailing whitespace`);
  });
  ...
  describe("Checks", () => {
    describe("check", () => {
      it("single check", async () => {
        ...
        await decoding.fail("ab", `Expected a value with a length of at least 3`);
      });
...
Expected a string including "c"`,
      ...
      it("aborting checks", async () => {
        ...
        const decoding = asserts.decoding();
        await decoding.fail("a", `Expected a value with a length of at least 2`);
      });
      ...
      it("makeFilterGroup", async () => {
        ...
        const decoding = asserts.decoding();
        await decoding.succeed("abc");
        await decoding.fail("", `Expected a value with a length of at least 3`);
      });
    ...
    it("refine", async () => {
      ...
      await decoding.fail(Option.some(""), `Expected length > 0`);
      await decoding.fail(Option.none(), `Expected isSome`);
    });
    ...
    describe("String checks", () => {
      it("isPattern", async () => {
        ...
        const decoding = asserts.decoding();
        await decoding.succeed("a");
        await decoding.fail("b", `Expected a string matching the RegExp ^a`);

        const encoding = asserts.encoding();
        await encoding.succeed("a");
        await encoding.fail("b", `Expected a string matching the RegExp ^a`);
      });
      ...
      it("isStartsWith", async () => {
        ...
        const decoding = asserts.decoding();
        await decoding.succeed("a");
        await decoding.fail("b", `Expected a string starting with "a"`);

        const encoding = asserts.encoding();
        await encoding.succeed("a");
        await encoding.fail("b", `Expected a string starting with "a"`);
      });
      ...
      it("isEndsWith", async () => {
        ...
        const decoding = asserts.decoding();
        await decoding.succeed("a");
        await decoding.fail("b", `Expected a string ending with "a"`);

        const encoding = asserts.encoding();
        await encoding.succeed("a");
        await encoding.fail("b", `Expected a string ending with "a"`);
      });
      ...
      it("isLowercased", async () => {
        ...
        const decoding = asserts.decoding();
        await decoding.succeed("a");
        await decoding.fail("A", `Expected a string with all characters in lowercase`);

        const encoding = asserts.encoding();
        await encoding.succeed("a");
        await encoding.fail("A", `Expected a string with all characters in lowercase`);
      });
      ...
      it("isUppercased", async () => {
        ...
        const decoding = asserts.decoding();
        await decoding.succeed("A");
        await decoding.fail("a", `Expected a string with all characters in uppercase`);

        const encoding = asserts.encoding();
        await encoding.succeed("A");
        await encoding.fail("a", `Expected a string with all characters in uppercase`);
      });
      ...
      it("isCapitalized", async () => {
        ...
        const decoding = asserts.decoding();
        await decoding.succeed("Abc");
        await decoding.fail("abc", `Expected a string with the first character in uppercase`);

        const encoding = asserts.encoding();
        await encoding.succeed("Abc");
        await encoding.fail("abc", `Expected a string with the first character in uppercase`);
      });
      ...
      it("isUncapitalized", async () => {
        ...
        const decoding = asserts.decoding();
        await decoding.succeed("aBC");
        await decoding.fail("ABC", `Expected a string with the first character in lowercase`);

        const encoding = asserts.encoding();
        await encoding.succeed("aBC");
        await encoding.fail("ABC", `Expected a string with the first character in lowercase`);
      });
      ...
      it("isMinLength", async () => {
        ...
        const decoding = asserts.decoding();
        await decoding.succeed("a");
        await decoding.fail("", `Expected a value with a length of at least 1`);

        const encoding = asserts.encoding();
        await encoding.succeed("a");
        await encoding.fail("", `Expected a value with a length of at least 1`);
      });
    });
    ...
    describe("Number checks", () => {
      it("isGreaterThan", async () => {
        ...
        await decoding.fail(1, `Expected a value greater than 1`);

        const encoding = asserts.encoding();
        await encoding.succeed(2);
        await encoding.fail(1, `Expected a value greater than 1`);
      });
      ...
      it("isGreaterThanOrEqualTo", async () => {
        ...
        const decoding = asserts.decoding();
        await decoding.succeed(1);
        await decoding.fail(0, `Expected a value greater than or equal to 1`);
      });
      ...
      it("isLessThan", async () => {
        ...
        await decoding.fail(1, `Expected a value less than 1`);
      });
      ...
      it("isLessThanOrEqualTo", async () => {
        ...
        const decoding = asserts.decoding();
        await decoding.succeed(1);
        await decoding.fail(2, `Expected a value less than or equal to 1`);
      });
      ...
      it("isMultipleOf", async () => {
        ...
        await decoding.fail(3, `Expected a value that is a multiple of 2`);
      });
      ...
      describe("isBetween", () => {
        it("included & included", async () => {
          ...
          await decoding.fail(0, `Expected a value between 1 and 3`);
          await decoding.fail(4, `Expected a value between 1 and 3`);

          const encoding = asserts.encoding();
          await encoding.succeed(1);
          await encoding.succeed(3);
          await encoding.fail(0, `Expected a value between 1 and 3`);
        });
        ...
        it("included & excluded", async () => {
          ...
          await decoding.fail(0, `Expected a value between 1 and 3 (excluded)`);
          await decoding.fail(4, `Expected a value between 1 and 3 (excluded)`);

          const encoding = asserts.encoding();
          await encoding.succeed(1);
          await encoding.fail(3, `Expected a value between 1 and 3 (excluded)`);
          await encoding.fail(0, `Expected a value between 1 and 3 (excluded)`);
        });
        ...
        it("excluded & included", async () => {
          ...
          await decoding.succeed(3);
          await decoding.fail(0, `Expected a value between 1 (excluded) and 3`);
          await decoding.fail(4, `Expected a value between 1 (excluded) and 3`);

          const encoding = asserts.encoding();
          await encoding.fail(1, `Expected a value between 1 (excluded) and 3`);
          await encoding.succeed(3);
          await encoding.fail(0, `Expected a value between 1 (excluded) and 3`);
        });
        ...
        it("excluded & excluded", async () => {
          ...
          await decoding.fail(0, `Expected a value between 1 (excluded) and 3 (excluded)`);
          await decoding.fail(4, `Expected a value between 1 (excluded) and 3 (excluded)`);
          ...
          await encoding.fail(0, `Expected a value between 1 (excluded) and 3 (excluded)`);
        });
      });
      ...
      it("isInt", async () => {
        ...
        const decoding = asserts.decoding();
        await decoding.succeed(1);
        await decoding.fail(1.1, `Expected an integer`);

        const encoding = asserts.encoding();
        await encoding.succeed(1);
        await encoding.fail(1.1, `Expected an integer`);
      ...
      it("isInt32", async () => {
        ...
        await decoding.fail(1.1, `Expected an integer`);
        await decoding.fail(Number.MIN_SAFE_INTEGER - 1, `Expected an integer`);
        const decodingAll = asserts.decoding({ parseOptions: { errors: "all" } });
        await decodingAll.fail(
...
Expected a value between -2147483648 and 2147483647`,
        ...
        await encoding.succeed(1);
        await encoding.fail(1.1, `Expected an integer`);
        await encoding.fail(Number.MAX_SAFE_INTEGER + 1, `Expected an integer`);
      });
    });
    ...
    describe("BigInt Checks", () => {
      ...
      it("isBetween", async () => {
        ...
        await decoding.fail(4n, `Expected a value between 5n and 10n`);
      });
      ...
      it("isGreaterThan", async () => {
        ...
        await decoding.fail(5n, `Expected a value greater than 5n`);
      });
      ...
      it("isGreaterThanOrEqualTo", async () => {
        ...
        await decoding.succeed(5n);
        await decoding.succeed(6n);
        await decoding.fail(4n, `Expected a value greater than or equal to 5n`);
      });
      ...
      it("isLessThan", async () => {
        ...
        await decoding.fail(5n, `Expected a value less than 5n`);
      });
      ...
      it("isLessThanOrEqualTo", async () => {
        ...
        await decoding.succeed(5n);
        await decoding.succeed(4n);
        await decoding.fail(6n, `Expected a value less than or equal to 5n`);
      });
    });
    ...
    describe("Record checks", () => {
      it("isMinProperties", async () => {
        ...
        await decoding.fail({}, `Expected a value with at least 1 entry`);
      });
      ...
      it("isMaxProperties", async () => {
        ...
        const decoding = asserts.decoding();
        await decoding.succeed({ a: 1, b: 2 });
        await decoding.fail({ a: 1, b: 2, c: 3 }, `Expected a value with at most 2 entries`);
        await decoding.fail({ a: 1, b: 2, c: 3 }, `Expected a value with at most 2 entries`);
      });
      ...
      it("isMinProperties with symbol keys", async () => {
        ...
        await decoding.fail({ [sym]: 1 }, `Expected a value with at least 2 entries`);
      });
      ...
      it("isPropertiesLengthBetween", async () => {
        ...
        await decoding.fail({ a: 1 }, `Expected a value with exactly 2 entries`);
        await decoding.fail({ a: 1, b: 2, c: 3 }, `Expected a value with exactly 2 entries`);
      });
      ...
      it("isPropertiesLengthBetween with symbol keys", async () => {
        ...
        await decoding.fail({ [sym1]: 1 }, `Expected a value with exactly 2 entries`);
        await decoding.fail(
          { [sym1]: 1, [sym2]: 2, a: 3 },
  ...
  describe("Transformations", () => {
    ...
    it("FiniteFromString", async () => {
      ...
      await decoding.fail("Infintiy", `Expected a finite number`);
      await decoding.fail("+Infintiy", `Expected a finite number`);
      await decoding.fail("-Infintiy", `Expected a finite number`);
    ...
    it("BigDecimalFromString", async () => {
      ...
      await encoding.fail("a", `Expected BigDecimal`);
    });
    ...
    it("TimeZoneNamedFromString", async () => {
      ...
      await encoding.fail("a", `Expected DateTime.TimeZone.Named`);
    });
    ...
    it("TimeZoneFromString", async () => {
      ...
      await encoding.fail("a", `Expected DateTime.TimeZone`);
    });
    ...
    it("DateTimeZonedFromString", async () => {
      ...
      await encoding.fail("a", `Expected DateTime.Zoned`);
    });
    ...
    it("FiniteFromString & isGreaterThan", async () => {
      ...
      await decoding.fail("1", `Expected a value greater than 2`);

      const encoding = asserts.encoding();
      await encoding.succeed(3, "3");
      await encoding.fail(1, `Expected a value greater than 2`);
    });
  });
  ...
  at ["a"]`,
    ...
    it("double transformation", async () => {
      ...
      await decoding.fail(" a2 ", `Expected a finite number`);
  ...
  describe("flip", () => {
    ...
    it("string & isMinLength(3) <-> number & isGreaterThan(2)", async () => {
      ...
      const decoding = asserts.decoding();
      await decoding.fail(2, `Expected a value greater than 2`);
      await decoding.fail(3, `Expected a value with a length of at least 3`);
    ...
    it("Struct & flip & check & flip should apply the check to the encoded side", async () => {
      ...
      const decoding = asserts.decoding();
      await decoding.fail({ a: "a" }, `Expected a length > 1`);
      await decoding.succeed({ a: "aa" });

      const encoding = asserts.encoding();
      await encoding.fail({ a: "a" }, `Expected a length > 1`);
    ...
    it("Tuple & flip & check & flip should apply the check to the encoded side", async () => {
      ...
      const decoding = asserts.decoding();
      await decoding.fail(["a"], `Expected head length > 1`);
      await decoding.succeed(["aa"]);

      const encoding = asserts.encoding();
      await encoding.fail(["a"], `Expected head length > 1`);
    ...
    it("Union & flip & check & flip should apply the check to the encoded side", async () => {
      ...
      const decoding = asserts.decoding();
      await decoding.fail("a", `Expected "aa"`);
      await decoding.succeed("aa");

      const encoding = asserts.encoding();
      await encoding.fail("a", `Expected "aa"`);
      await encoding.succeed("aa");
    });
    ...
    it("Declaration & flip & check & flip should apply the check to the encoded side", async () => {
      ...
      const decoding = asserts.decoding();
      await decoding.fail("a", `Expected a length > 1`);
      await decoding.succeed("aa");

      const encoding = asserts.encoding();
      await encoding.fail("a", `Expected a length > 1`);
      await encoding.succeed("aa");
    });
    ...
    it("Struct & flip & check & flip with encoding chain should check the local value", async () => {
      ...
      const decoding = asserts.decoding();
      await decoding.fail({ b: "a" }, `Expected a length > 1`);
  ...
  it("Error", async () => {
    ...
    await decoding.fail({ message: "a" }, `Expected Error`);
    await decoding.fail("a", `Expected Error`);

    const encoding = asserts.encoding();
    await encoding.succeed(error);
    await encoding.succeed(customError);
    await encoding.fail({ message: "a" }, `Expected Error`);
    await encoding.fail("a", `Expected Error`);
  });
  ...
  describe("Exit", () => {
    ...
    it("Exit(FiniteFromString, String, Unknown)", async () => {
      ...
      await decoding.fail(null, `Expected Exit`);
      await decoding.fail(
        Exit.succeed(123),
        `Expected string
  at ["value"]`,
  ...
  describe("Union", () => {
    ...
    it(`String | Number`, async () => {
      ...
      await decoding.succeed("a");
      await decoding.succeed(1);
      await decoding.fail(null, `Expected string | number`);
    });
    ...
    it(`mode: "oneOf"`, async () => {
      ...
      await decoding.fail({ a: "a", b: 1 }, "Expected exactly one member to match");
    });
    ...
    it(`mode: "oneOf" with nested and contradicted sentinels`, async () => {
      ...
      const schema = Schema.Struct({
        block: Schema.Union([nested, Schema.Struct({ kind: Schema.Literal("b") })], {
          mode: "oneOf",
        }),
      });
      const decoding = new TestSchema.Asserts(schema).decoding();
  ...
  at ["block"]`,
    ...
    it(`mode: "oneOf" counts repeated member occurrences`, async () => {
      ...
      const decoding = asserts.decoding();
      await decoding.fail({ kind: "a" }, "Expected exactly one member to match");
    });
    ...
    it("preserves recovering members during runtime type dispatch", async () => {
      ...
      const decoding = new TestSchema.Asserts(
        Schema.Union([decodingFallback, Schema.Null]),
      ).decoding();
      await decoding.succeed(null, "fallback");

      const transformedDecoding = new TestSchema.Asserts(
        Schema.Union([transformedFallback, Schema.Null]),
      ).decoding();
      await transformedDecoding.succeed(null, 0);

      const nestedDecoding = new TestSchema.Asserts(
        Schema.Union([nestedFallback, Schema.Null]),
      ).decoding();
      ...
      const encoding = new TestSchema.Asserts(
        Schema.Union([encodingFallback, Schema.Null]),
      ).encoding();
    ...
    it("Struct({}) preserves its semantics in a union", async () => {
      const schema = Schema.Union([Schema.Struct({}), Schema.Null]);
      const asserts = new TestSchema.Asserts(schema);
    ...
    describe("should exclude members based on failed sentinels", () => {
      it("string | struct", async () => {
        ...
        const decoding = asserts.decoding();
        await decoding.fail({}, `Expected string | { readonly "_tag": "a", ... }`);
      });
      ...
      it("string | tuple", async () => {
        ...
        const decoding = asserts.decoding();
        await decoding.fail([], `Expected string | readonly [ "a", ... ]`);
      });
  ...
  at [1]`,
        ...
        await decoding.fail(["c"], `Expected readonly [ "a", ... ] | readonly [ "b", ... ]`);
      });
    });
  });
  ...
  at ["ab"]`,
    ...
    it("should preserve both checks", async () => {
      ...
      await decoding.succeed({ a: 1 });
      await decoding.succeed({ a: 1, b: 2 });
      await decoding.fail({ a: 0 }, `Expected agt(0)`);
      await decoding.fail({ a: 1, b: 1 }, `Expected bgt(1)`);
    });
  ...
  describe("BigDecimal checks", () => {
    it("isGreaterThanBigDecimal", async () => {
      ...
      await decoding.fail(BigDecimal.fromStringUnsafe("1"), `Expected a value greater than 1`);
    });
    ...
    it("isLessThanBigDecimal", async () => {
      ...
      await decoding.fail(BigDecimal.fromStringUnsafe("1"), `Expected a value less than 1`);
    });
    ...
    it("isBetweenBigDecimal", async () => {
      ...
      await decoding.fail(BigDecimal.fromStringUnsafe("0"), `Expected a value between 1 and 5`);
    });
  });
  ...
  it("URLFromString", async () => {
    ...
    await decoding.fail("123", "Expected a valid URL string");
  ...
  describe("UnknownFromJsonString / fromJsonString", () => {
    it("use case: Unknown <-> JSON string", async () => {
      ...
      const decoding = asserts.decoding();
      await decoding.succeed(`{"a":1}`, { a: 1 });
      await decoding.fail(`{"a"`, "Expected a valid JSON string");
  ...
  it("Trim", async () => {
    ...
    const encoding = asserts.encoding();
    await encoding.succeed("a");
    await encoding.fail("a ", `Expected a string with no leading or trailing whitespace`);
  });
  ...
  describe("TemplateLiteral", () => {
    ...
    it(`"a"`, async () => {
      ...
      await decoding.succeed("a");
      await decoding.fail(null, "Expected string");
      await decoding.fail("ab", "Expected a string matching template literal parts");
      await decoding.fail("", `Expected a string matching template literal parts`);
    });
    ...
    it(`"a b"`, async () => {
      ...
      await decoding.fail("a  b", `Expected a string matching template literal parts`);
    });
    ...
    it(`"[" + string + "]"`, async () => {
      ...
      await decoding.fail("a", `Expected a string matching template literal parts`);
    });
    ...
    it(`"a" + number`, async () => {
      ...
      await decoding.fail(null, "Expected string");
      await decoding.fail("", `Expected a string matching template literal parts`);
      await decoding.fail("aa", `Expected a string matching template literal parts`);
    });
    ...
    it(`"a" + bigint`, async () => {
      ...
      await decoding.fail("", `Expected a string matching template literal parts`);
      await decoding.fail("aa", `Expected a string matching template literal parts`);
      await decoding.fail("a1.2", `Expected a string matching template literal parts`);
      await decoding.fail("a+1", `Expected a string matching template literal parts`);
    });
    ...
    it(`"a" + string + "b"`, async () => {
      ...
      await decoding.fail("", `Expected a string matching template literal parts`);
      await decoding.fail("a", `Expected a string matching template literal parts`);
      await decoding.fail("b", `Expected a string matching template literal parts`);
    ...
    it("https://www.typescriptlang.org/docs/handbook/2/template-literal-types.html", async () => {
      ...
      await decoding.fail("_id", `Expected a string matching template literal parts`);
    });
    ...
    it("< + h + (1|2n) + >", async () => {
      ...
      await decoding.fail("<h3>", `Expected a string matching template literal parts`);
    });
  ...
  describe("TemplateLiteralParser", () => {
    ...
    it(`Int + "a"`, async () => {
      ...
      await decoding.fail("1.1a", `Expected a string matching template literal parts`);
  ...
  at [1]`,
      ...
      await decoding.fail("ed", `Expected a string matching template literal parts`);
    });
  ...
  describe("Class", () => {
    ...
    it("make validates a nested Class source and output once", () => {
      ...
      let classChecks = 0;
      class A extends Schema.Class<A>("A")(
        Schema.Struct({ a: Schema.String }).check(
          Schema.makeFilter(() => {
            sourceChecks++;
            return true;
          }),
    ...
    it("make preserves Class instances in Array(Class) and Array(Union(Class))", () => {
      ...
      class DirectTable extends Schema.Class<DirectTable>("DirectTable")({
  ...
  at ["a"]`,
      ...
      await encoding.fail(null, "Expected A");
      await encoding.fail({ a: "a" }, `Expected A`);
    });
  ...
  describe("Enum", () => {
    ...
    it("Numeric enum", async () => {
      ...
      await decoding.fail(3, `Expected 0 | 1`);
    ...
    it("String enum", async () => {
      ...
      await decoding.fail("Cantaloupe", `Expected "apple" | "banana" | 0`);
    ...
    it("Const enum", async () => {
      ...
      await decoding.fail("Cantaloupe", `Expected "apple" | "banana" | 3`);
  ...
  describe("catchDecoding", () => {
    it("sync fallback", async () => {
      ...
      const encoding = asserts.encoding();
      await encoding.succeed("a");
      await encoding.fail(null, "Expected string");
    });
    ...
    it("forced failure", async () => {
      const schema = Schema.String.pipe(
        Schema.middlewareDecoding(() =>
          Effect.fail(new SchemaIssue.Forbidden({ message: "my message" })),
        ),
      );
      const asserts = new TestSchema.Asserts(schema);
  ...
  describe("Schema.makeFilter", () => {
    ...
    it("returns false", async () => {
      ...
      const asserts = new TestSchema.Asserts(schema);
      const decoding = asserts.decoding();
      await decoding.fail("a", `Expected <filter>`);
    });
...
error message 2`,
      ...
      it("abort: true", async () => {
        const schema = Schema.String.check(
          Schema.makeFilter(
            () => new SchemaIssue.InvalidValue({ message: "error message 1" }),
            {
              title: "filter title 1",
            },
            true,
      ...
      it("issue: Issue", async () => {
        const schema = Schema.String.check(
          Schema.makeFilter(
            () => ({
              path: ["a"],
              issue: new SchemaIssue.InvalidValue({ message: "custom issue" }),
            }),
            { title: "filter title" },
          ),
        );
...
pointed message
    ...
    describe("toTaggedUnion", () => {
      it("should augment a union of structs", () => {
        ...
        deepStrictEqual(
          pipe(
            { _tag: b, b: 1 },
            schema.matchOrElse({ A: () => "A" }, (value) => value._tag),
          ),
          b,
        );
          ...
          Schema.withDecodingDefaultKey(
            Effect.fail(
              new Schema.SchemaError(
                new SchemaIssue.InvalidValue({ message: "decoding default failed" }),
              ),
            ),
          ),
        ),
  ...
  it("Char", async () => {
    ...
    const decoding = asserts.decoding();
    await decoding.succeed("a");
    await decoding.fail("ab", `Expected a value with a length of 1`);

    const encoding = asserts.encoding();
    await encoding.succeed("a");
    await encoding.fail("ab", `Expected a value with a length of 1`);
  });
  ...
  it("Natural", async () => {
    ...
    await decoding.succeed(0);
    await decoding.succeed(1);
    await decoding.fail(-1, `Expected a value greater than or equal to 0`);
    await decoding.fail(1.1, `Expected an integer`);

    const encoding = asserts.encoding();
    await encoding.succeed(0);
    await encoding.fail(-1, `Expected a value greater than or equal to 0`);
  });
  ...
  it("Lowercase", async () => {
    ...
    const encoding = asserts.encoding();
    await encoding.succeed("abc");
    await encoding.fail("ABC", `Expected a string with all characters in lowercase`);
  });
  ...
  it("Uppercase", async () => {
    ...
    const encoding = asserts.encoding();
    await encoding.succeed("ABC");
    await encoding.fail("abc", `Expected a string with all characters in uppercase`);
  });
});
...
describe("Check", () => {
  ...
  it("isUUID", async () => {
    ...
    await decoding.fail("00000000-0000-0000-0000-000000000001", `Expected a UUID`);
  });
  ...
  it("isUUID version-specific checks reject nil and max UUIDs", async () => {
    ...
    await decoding.succeed("00000000-0000-4000-8000-000000000001");
    await decoding.fail("00000000-0000-0000-0000-000000000000", `Expected a UUID v4`);
    await decoding.fail("ffffffff-ffff-ffff-ffff-ffffffffffff", `Expected a UUID v4`);
  });
  ...
  it("isGUID", async () => {
    ...
    await decoding.succeed("FFFFFFFF-FFFF-FFFF-FFFF-FFFFFFFFFFFF");
    await decoding.fail("not-a-guid", `Expected a GUID`);
  });
