...
export const makeServerLayer = (options: {
  ...
  readonly protocols?:
    | readonly [McpProtocol.ProtocolAdapter, ...Array<McpProtocol.ProtocolAdapter>]
    | undefined;
  ...
  }).pipe(Layer.provideMerge(Layer.succeed(References.CurrentLoggers, new Set([noopLogger]))));
