      ...
      describe("Capabilities", () => {
          ...
          () =>
            Effect.gen(function* () {
              ...
              const peer = yield* test.makePeer({
                ...
                handlers: {
                  "elicitation/create": () =>
                    Effect.succeed({ action: "accept", content: { name: "Ada" } }),
                },
              });
        ...
        it.effect.skipIf(protocol.protocolVersion !== "2025-11-25")(
          ...
          () =>
            Effect.gen(function* () {
              const test = yield* McpConformance;
              const formOnly = yield* test.makePeer({
              ...
              const urlOnFormOnly = yield* Effect.exit(
                formOnly.reverseClient.elicit({
                  mode: "url",
