...
describe("LanguageModel", () => {
    ...
    it.effect("preserves encoded tool parameters when tool call resolution is disabled", () =>
      Effect.gen(function* () {
        ...
        const results = yield* toolkit
          .handle(toolCall.name, toolCall.params)
  ...
  describe("provider options", () => {
    ...
    it.effect(
      "calls tracker.prepareUnsafe after stripping resolved approvals in toolkit flow",
      () =>
        Effect.gen(function* () {
    ...
    it.effect(
      "calls tracker.prepareUnsafe after stripping resolved approvals in streamText toolkit flow",
      () =>
        Effect.gen(function* () {
    ...
    it.effect(
      "uses tracker prepareUnsafe and markParts when disableToolCallResolution is true",
      () =>
        Effect.gen(function* () {
  ...
  describe("tool approval", () => {
    ...
    it.effect(
      "strips previous-round approval artifacts even when no new pending approvals (streamText)",
      () =>
        Effect.gen(function* () {
    ...
    it.effect(
      "strips previous-round approval artifacts even when no new pending approvals (generateText)",
      () =>
        Effect.gen(function* () {
