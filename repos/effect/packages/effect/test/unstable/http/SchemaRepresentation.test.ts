...
describe("HTTP schema representations", () => {
  it("generates code for declaration schemas", () => {
    ...
    assert.deepStrictEqual(output.codes, [
      {
        runtime: `Headers.HeadersSchema.annotate({ "expected": "Headers" })`,
        Type: "Headers.Headers",
      },
      {
        runtime: `Cookies.CookiesSchema.annotate({ "expected": "Cookies" })`,
        Type: "Cookies.Cookies",
      },
      {
        runtime: `Cookies.CookieSchema.annotate({ "expected": "Cookie" })`,
        Type: "Cookies.Cookie",
      },
      {
        runtime: `UrlParams.UrlParamsSchema.annotate({ "expected": "UrlParams" })`,
