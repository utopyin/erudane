...
const withTrickyChoices = Command.make("deploy", {
  mode: Flag.choice("mode", trickyValues).pipe(Flag.withDescription("Deploy mode")),
...
describe("Fish completions", () => {
  it("scopes nested completions by the full command path", () => {
    ...
    const descriptor: Completions.CommandDescriptor = {
      ...
      subcommands: [
        ...
        },
        {
          ...
          flags: [],
          arguments: [],
          subcommands: [leaf("common", "beta-only")],
        },
      ],
    };
    ...
    assert.include(
      alphaOnly,
      "__fish_seen_subcommand_from alpha; and __fish_seen_subcommand_from common",
    );
    assert.include(
      betaOnly,
      "__fish_seen_subcommand_from beta; and __fish_seen_subcommand_from common",
    );
  });
