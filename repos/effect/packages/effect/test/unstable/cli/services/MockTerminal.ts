...
export const displayLines: Effect.Effect<
  ReadonlyArray<string>,
  never,
  Terminal.Terminal
> = Effect.flatMap(MockTerminal, (terminal) => terminal.displayLines);
...
export const readLine: Effect.Effect<string, Terminal.QuitError, Terminal.Terminal> =
