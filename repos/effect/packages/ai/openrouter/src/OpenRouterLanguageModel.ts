...
> {
  ...
  let tools: Array<
    Extract<typeof Generated.ChatFunctionTool.Encoded, { readonly type: "function" }>
  > = [];
...
const annotateRequest = (span: Span, request: typeof Generated.ChatRequest.Encoded): void => {
...
): typeof Generated.ChatContentCacheControl.Encoded | null =>
...
const getResponseFormat = Effect.fnUntraced(function* ({
  ...
  typeof Generated.ChatFormatJsonSchemaConfig.Encoded | undefined,
  AiError.AiError
> {
