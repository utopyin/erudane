...
const jsBundle = await fetch("https://unpkg.com/swagger-ui-dist/swagger-ui-bundle.js").then((res) =>
  res.text(),
);
const jsPreset = await fetch(
  "https://unpkg.com/swagger-ui-dist/swagger-ui-standalone-preset.js",
).then((res) => res.text());
const css = await fetch("https://unpkg.com/swagger-ui-dist/swagger-ui.css").then((res) =>
  res.text(),
);
